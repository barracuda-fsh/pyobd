                ...
                if curstate == 0:  # show status tab
                    ...
                    try:
                        if misfire_cylinder_supported:
                            r = self.connection.connection.query(core.commands.MONITOR_MISFIRE_CYLINDER_1)
                            ...
                            r = self.connection.connection.query(core.commands.MONITOR_MISFIRE_CYLINDER_2)
                            result = r.value.MISFIRE_COUNT
                            if not result.is_null():
                            ...
                            r = self.connection.connection.query(core.commands.MONITOR_MISFIRE_CYLINDER_3)
                            result = r.value.MISFIRE_COUNT
                            if not result.is_null():
                            ...
                            r = self.connection.connection.query(core.commands.MONITOR_MISFIRE_CYLINDER_4)
                            result = r.value.MISFIRE_COUNT
                            if not result.is_null():
