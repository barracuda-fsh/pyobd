...
from pyobd.debug_event import EVT_DEBUG_ID, DebugEvent
            ...
            while self._notify_window.ThreadControl != 666:
                ...
                if curstate == 0:  # show status tab
                    ...
                    try:
                        ...
                        response = self.connection.connection.query(
                    ...
                    if first_time_sensors:
                        ...
                        for sens in sensor_list:
                            ...
                            wx.PostEvent(
                                self._notify_window,
                                ResultEvent(
                                    [counter, 0, sens[0].command.decode("utf-8")]
                                ),
                            )
                            wx.PostEvent(
                                self._notify_window,
